...
namespace DataLayer.Migrations
{
    ...
    [Migration("20260626160154_Phase29AdminContentManagementCompletion")]
    partial class Phase29AdminContentManagementCompletion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Entities.FullExamAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StudentId")
                        .HasDatabaseName("IX_FullExamAttempts_StudentId");

                    b.ToTable("FullExamAttempts", (string)null);
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.PracticeTest", b =>
                {
                    ...
                    b.HasIndex("IsMockExam")
                        .HasDatabaseName("IX_PracticeTests_IsMockExam");
            ...
            modelBuilder.Entity("DataLayer.Entities.PracticeTestQuestion", b =>
                {
                    ...
                    b.HasIndex("QuestionBankQuestionId")
                        .HasDatabaseName("IX_PracticeTestQuestions_QuestionBankQuestionId");
            ...
            modelBuilder.Entity("DataLayer.Entities.QuestionBankQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("WrongAnswerExplanation")
                        .IsRequired()
                        .HasMaxLength(3000)
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("IX_QuestionBank_Status");

                    b.HasIndex("Topic")
                        .HasDatabaseName("IX_QuestionBank_Topic");

                    b.HasIndex("CategoryId", "Difficulty")
                        .HasDatabaseName("IX_QuestionBank_Category_Difficulty");
            ...
            modelBuilder.Entity("DataLayer.Entities.StudyPlanner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StudentId")
                        .IsUnique()
                        .HasDatabaseName("IX_StudyPlanners_StudentId");

                    b.ToTable("StudyPlanners", (string)null);
                });
            ...
            modelBuilder.Entity("DataLayer.Entities.PracticeTestQuestion", b =>
                {
                    ...
                    b.HasOne("DataLayer.Entities.QuestionBankQuestion", "QuestionBankQuestion")
                        .WithMany("PracticeTestQuestions")
            ...
            modelBuilder.Entity("DataLayer.Entities.QuestionBankQuestion", b =>
                {
                    b.Navigation("PracticeTestQuestions");
                });
