        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxUses = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    UsedCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    StartsAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExpiresAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    RestrictedToCourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coupons_DiscountPercentage", "[DiscountPercentage] >= 1 AND [DiscountPercentage] <= 100");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewVideoUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResourcesUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxAttempts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ShuffleQuestions = table.Column<bool>(type: "bit", nullable: false),
                    ShowAnswersAfterSubmission = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeTakenSeconds = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    AnswersSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
